...
function Shop(){
  ...
  useEffect(()=>{
    ...
    return(
        ...
        <SwiperSlide><PreviewCard stock price={120} size={10} name={'Phanteks Eclipse G300A Black 3-fan Midi Tower Behuizing'} image={pc5}/></SwiperSlide>
        <SwiperSlide><PreviewCard stock price={100} size={9} name={'DeepCool CC560 A-RGB Midi Tower'} image={pc6}/></SwiperSlide>
        <SwiperSlide><PreviewCard stock price={300} size={6} name={'be quiet! Pure Base 500DX Black Midi Tower'} image={pc7}/></SwiperSlide>
        <SwiperSlide><PreviewCard stock price={80} size={8} name={'MSI MAG VAMPIRIC 100R Midi Tower Case'} image={pc1}/></SwiperSlide>
        <SwiperSlide><PreviewCard stock price={150} size={7} name={'NZXT H5 Flow RGB Black Midi Tower Behuizing'} image={pc2}/></SwiperSlide>
        <SwiperSlide><PreviewCard stock price={150} size={6.5} name={'Fractal Design Pop Air RGB Black TG Clear Tint Midi Tower'} image={pc3}/></SwiperSlide>
        </Swiper>
